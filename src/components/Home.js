            ...
            <div className="container-home" id="parallax">
                <div> 
                        <div id="select">
                            ...
                            <MenuLink label='History' to='/a' activeOnly={false}/>
                            <MenuLink label='Culture' to='/b' activeOnly={false}/>
                            <MenuLink label='Cuisine' to='/c' activeOnly={false}/>
                            <MenuLink label='Music' to='/d' activeOnly={false}/>
                            <MenuLink label='Beauty' to='/e' activeOnly={false}/>
                        </div>
                ...
                <div className="home-body">
                    ...
                    <div className="container" id="nature">
                    ...
                    <div className="container" id="music">
                        <img src='./nhacsi.png' className="music-img" data-aos="fade-up" style={{left: '5%', width: '25%', bottom: '60%'}}/>
                        <img src='./baihat.png' className="music-img" data-aos="fade-down" style={{left: '10%', width: '25%', bottom: '20%'}}/>
                        <img src='./casi.png' className="music-img" data-aos="fade-up" style={{left: '30%', width: '25%', bottom: '0%'}}/>
                    ...
                    <div className="container" id="people">
                        <img src='./3mien.png' className="people-img" data-aos="fade-right" style={{width: '30%', bottom: '0%', left: '5%'}}/>
                        <img src='./dantoc.png' className="people-img" data-aos="fade-left" style={{width: '58%', bottom: '0%', left: '38%'}}/>
